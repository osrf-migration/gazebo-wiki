# Build Cop Report 2020-01-06
## Aggregate Results as of 2020-01-06 17:10:57
...
* Assigned to
    ...
    * [![Build Status](https://build.osrfoundation.org/job/ignition_msgs-ci-ign-msgs4-homebrew-amd64//badge/icon)](https://build.osrfoundation.org/job/ignition_msgs-ci-ign-msgs4-homebrew-amd64/) [ignition_msgs-ci-ign-msgs4-homebrew-amd64](https://build.osrfoundation.org/job/ignition_msgs-ci-ign-msgs4-homebrew-amd64/)
        * Failure from Dec 23rd due to outdated xcode on glados.mojave. This should be fixed - need to retrigger build to confirm.
