# Build Cop Report 2019-02-15

## Summary

3 Fixed windows builds. One new failure related to the WIP of ros2_gazebo_pkgs.

## Aggregate Results as of 2019-02-15 15:49:19.859830
...
* Assigned to: WIP https://bitbucket.org/osrf/release-tools/pull-requests/745/ 
 
    * [![Build Status](https://build.osrfoundation.org/job/ros2_gazebo_pkgs-ci-default_dashing-bionic-amd64//badge/icon)](https://build.osrfoundation.org/job/ros2_gazebo_pkgs-ci-default_dashing-bionic-amd64/) [ros2_gazebo_pkgs-ci-default_dashing-bionic-amd64](https://build.osrfoundation.org/job/ros2_gazebo_pkgs-ci-default_dashing-bionic-amd64/)
