# Build Cop Report 2019-08-26
## Aggregate Results as of 2019-08-26 17:52:54
...
* Assigned to
    ...
    * [![Build Status](https://build.osrfoundation.org/job/ignition_sensors-ci-ign-sensors2-bionic-amd64//badge/icon)](https://build.osrfoundation.org/job/ignition_sensors-ci-ign-sensors2-bionic-amd64/) [ignition_sensors-ci-ign-sensors2-bionic-amd64](https://build.osrfoundation.org/job/ignition_sensors-ci-ign-sensors2-bionic-amd64/)
        * Should be fixed once the ign-rendering 2.1 is released into stable repo
