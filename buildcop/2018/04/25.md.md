...
* Recent ffmpeg4 release in homebrew caused compilation errors
    ...
    * https://bitbucket.org/osrf/gazebo/pull-requests/2942/fix-build-on-homebrew-with-ffmpeg4/diff (merged! this should fix the 3 above homebrew build failures)