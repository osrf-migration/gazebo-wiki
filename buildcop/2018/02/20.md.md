...
* [gazebo-ci-default-xenial-amd64-gpu-none: FuelModelDatabaseTest.FuelDown](https://build.osrfoundation.org/view/main/view/BuildCopFail/job/gazebo-ci-default-xenial-amd64-gpu-none/323/testReport/(root)/FuelModelDatabaseTest/FuelDown/)